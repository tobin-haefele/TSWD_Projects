...
In this last section I want to focus on the agencies/programs that refer individuals to the Housing Solutions Fund. The main question I had is if there is a significant difference between the amount of money an individual gets based off of their referring entity. Using a simple regression model to see if there is any statistical significance between the Referral forms. 
